# Generated by Django 6.0 on 2026-02-17 21:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='opcuanode',
            name='display_type',
            field=models.CharField(choices=[('numeric', '📊 Numeric Display'), ('gauge', '🎯 Gauge (Linear)'), ('gauge-circular', '🎡 Gauge (Circular)'), ('progress', '📈 Progress Bar'), ('switch', '🔘 Toggle Switch (Boolean)'), ('status-indicator', '🟢 Status Indicator'), ('chart', '📉 Mini Chart')], default='numeric', help_text='How to display this node in the UI', max_length=20),
        ),
        migrations.AddField(
            model_name='opcuanode',
            name='icon',
            field=models.CharField(blank=True, choices=[('zap', '⚡ Power'), ('droplet', '💧 Flow/Liquid'), ('gauge', '📏 Pressure/Level'), ('thermometer', '🌡️ Temperature'), ('battery', '🔋 Battery'), ('wind', '💨 Air Flow'), ('settings', '⚙️ Status'), ('alert', '⚠️ Alert'), ('check-circle', '✓ Operational'), ('x-circle', '✗ Fault')], default='', help_text='Icon category for UI grouping', max_length=20),
        ),
        migrations.AddField(
            model_name='opcuanode',
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(default=5000, help_text='✓ Acknowledge timeout in milliseconds. Wait time for write operations to complete. Typical: 3000-5000ms. Range: 1000-30000ms', validators=[django.core.validators.MinValueValidator(1000), django.core.validators.MaxValueValidator(30000)]),
        ),
        migrations.AlterField(
            model_name='opcuaclientconfig',
            name='connection_time_out',
            field=models.IntegerField(default=5000, help_text='🔌 Connection timeout in milliseconds. How long to wait for server to respond to connection. Local: 3000-5000ms | Remote: 10000-15000ms | Slow: 20000-30000ms. Range: 1000-30000ms', validators=[django.core.validators.MinValueValidator(1000), django.core.validators.MaxValueValidator(30000)]),
        ),
        migrations.AlterField(
            model_name='opcuaclientconfig',
            name='request_time_out',
            field=models.IntegerField(default=10000, help_text='📝 Request timeout in milliseconds. Time to wait for OPC UA server to respond to read/write requests. Typical: 5000-10000ms. Range: 1000-60000ms', validators=[django.core.validators.MinValueValidator(1000), django.core.validators.MaxValueValidator(60000)]),
        ),
        migrations.AlterField(
            model_name='opcuaclientconfig',
            name='secure_time_out',
            field=models.IntegerField(default=10000, help_text='🔒 Secure channel timeout in milliseconds. For encrypted connections only. Minimum 5000ms recommended for secure channels. Range: 5000-30000ms', validators=[django.core.validators.MinValueValidator(5000), django.core.validators.MaxValueValidator(30000)]),
        ),
        migrations.AlterField(
            model_name='opcuaclientconfig',
            name='session_time_out',
            field=models.IntegerField(default=60000, help_text='⏱️ Session timeout in milliseconds. Server keeps session alive this long with no activity. Typical: 30000-60000ms (30-60s). Increase if frequent disconnects. Range: 5000-600000ms', validators=[django.core.validators.MinValueValidator(5000), django.core.validators.MaxValueValidator(600000)]),
        ),
        migrations.AlterField(
            model_name='opcuaclientconfig',
            name='subscription_interval',
            field=models.IntegerField(default=5000, help_text='📈 Subscription interval in milliseconds. How often to read values from OPC UA server. Fast sensors: 1000ms | General: 5000ms | Slow sensors: 30000ms. ⚠️ MUST MATCH other SCADA systems for accurate data comparison. Range: 1000-60000ms', validators=[django.core.validators.MinValueValidator(1000), django.core.validators.MaxValueValidator(60000)]),
        ),
        migrations.AlterField(
            model_name='opcuanode',
            name='last_value',
